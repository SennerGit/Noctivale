...
public abstract class ModRecipeHelper extends RecipeProvider {
    ...
    protected final void pestleAndMotorRecipe(RecipeOutput output, ItemLike ingredient, ItemLike result) {
        pestleAndMotorRecipe(output, ingredient, result, 2);
    }

    protected final void pestleAndMotorRecipe(RecipeOutput output, ItemLike ingredient, ItemLike result, int count) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, result, count)
                .requires(ingredient)
                .requires(NoctivaleItems.PESTLE_AND_MORTAR.get())
                .unlockedBy("has_" + ModUtils.getItemLikeId(ingredient), has(ingredient))
                .unlockedBy("has_" + ModUtils.getItemLikeId(NoctivaleItems.PESTLE_AND_MORTAR.get()), has(NoctivaleItems.PESTLE_AND_MORTAR.get()))
                .group(ModUtils.getItemLikeId(ingredient))
                .save(output, ModUtils.getModPath(ModUtils.getItemLikeId(result) + "_pestal_and_motor_" + ModUtils.getItemLikeId(ingredient) + "_to_" + ModUtils.getItemLikeId(result)));
    }
    ...
    protected final void pestalAndMotorRecipe(RecipeOutput output, ItemLike ingredient, ItemLike result) {
        pestalAndMotorRecipe(output, ingredient, result, 2);
    }

    protected final void pestalAndMotorRecipe(RecipeOutput output, ItemLike ingredient, ItemLike result, int count) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, result, count)
                .unlockedBy("has_item", has(ingredient))
                .group(ModUtils.getItemLikeId(ingredient))
                .save(output, ModUtils.getModPath(ModUtils.getItemLikeId(result) + "_pestal_and_motor_" + ModUtils.getItemLikeId(result)));
    }
}
